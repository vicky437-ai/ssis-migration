BEGIN
 ...
 IF (NOT EXISTS (SELECT 1 FROM
  ...
  WHERE
   SCHEMA_NAME = 'stg')) THEN
  !!!RESOLVE EWI!!! /*** SSC-EWI-0030 - THE STATEMENT BELOW HAS USAGES OF DYNAMIC SQL. ***/!!!
  EXECUTE IMMEDIATE '--CREATE SCHEMA stg';
 END IF;
END;
...
COMMENT = '{ "origin": "sf_sc", "name": "snowconvert", "version": {  "major": 2,  "minor": 33,  "patch": "0-Pr.127" }, "attributes": {  "component": "transact",  "convertedOn": "06-26-2026",  "domain": "no-domain-provided",  "migrationid": "yASfAe1ypXmJ5bs0pE1RPA==" }}'
;
...
-------------------------------------------------------------------------
CREATE OR REPLACE TABLE stg.Product (
 ProductAlternateKey NVARCHAR(25) NULL,
 EnglishProductName NVARCHAR(50) NOT NULL,
 ProductSubcategoryKey INT NULL,
 Color NVARCHAR(15) NULL,
...
CREATE OR REPLACE TABLE stg.SalesReseller (
 ProductAlternateKey NVARCHAR(25) NULL,
 CustomerAlternateKey NVARCHAR(15) NULL,
 SalesTerritoryKey INT NULL,
 SalesOrderNumber NVARCHAR(20) NOT NULL,
